...
import faceDetection from "./services/faceDetection/faceDetection";
...
function App() {
  ...
  const startFaceDetection = (camera, stream) => {
    const canvas = canvasRef?.current;
    faceDetection
      .startFaceDetector(camera, canvas, {
  ...
  const handleScreenshot = async () => {
    try {
      ...
      await faceDetection.detectImage(canvasElement, canvasElement);
  ...
  const stopDetector = () => {
    faceDetection.stopFaceDetector(() => {
